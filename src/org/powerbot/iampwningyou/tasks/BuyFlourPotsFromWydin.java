...
public class BuyFlourPotsFromWydin extends Task <ClientContext> {
...
//	When the window for Wydin's store is open.
	...
	public boolean activate() {
		return FlourRunner.currentShopBuyingFrom == ShopId.WYDIN
...
//			Checks the number of pot of flours left.
			if (potsOfFlour.itemStackSize() == 0) {
				FlourRunner.task = "Banking before going to Taverly to buy more flowers.";
				FlourRunner.currentShopBuyingFrom = ShopId.RAMSEY;
			}
